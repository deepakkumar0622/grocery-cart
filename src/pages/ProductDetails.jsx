...
const ProductDetails = () => {
  ...
  useEffect(() => {
    if (products.length > 0) {
      ...
      productCopy = productCopy.filter((v) => product.category === v.category);
      ...
      <div className="mt-12">
        ...
        <div className="flex flex-col mt-20 items-center">
          ...
          <button
            ...
            className="py-2.5 px-12 mx-auto my-16 cursor-pointer border rounded text-primary hover:bg-primary/10 transition"
          >
            See more
          </button>
        </div>
